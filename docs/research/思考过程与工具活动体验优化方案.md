...
> 关联文档：`docs/research/Claude思考流式输出方案.md`、`docs/research/流式输出体验优化技术方案.md`、`docs/architecture/05-scrolling.md`
...
| 文件 | 修改 |
| --- | --- |
| `docs/research/Claude思考流式输出方案.md` | 更新“结束约 1 秒自动收起”的旧验收事实，链接本方案 |
