...
export const FONT_FAMILY_CSS: Record<FontFamilyId, string> = {
  system: '-apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif', serif: 'ui-serif, Georgia, Cambria, "Times New Roman", Times, serif', sans: '"Heiti SC", "SimHei", "Microsoft YaHei", ui-sans-serif, sans-serif', songti: '"Songti SC", "SimSun", serif', kaiti: '"Kaiti SC", "STKaiti", "KaiTi", serif', rounded: 'ui-rounded, "Yuanti SC", "PingFang SC", sans-serif', 'jetbrains-mono': '"JetBrains Mono", ui-monospace, "SF Mono", Menlo, Consolas, monospace', monospace: 'ui-monospace, "SF Mono", "JetBrains Mono", Menlo, Consolas, monospace',
};
export const CODE_FONT_FAMILY_CSS: Record<CodeFontFamilyId, string> = {
  system: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', 'jetbrains-mono': '"JetBrains Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', 'fira-code': '"Fira Code", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', 'cascadia-code': '"Cascadia Code", "Cascadia Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', 'source-code-pro': '"Source Code Pro", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', hack: 'Hack, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', 'ibm-plex-mono': '"IBM Plex Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace',
};
