...
import type { BatchArchivedSessionDeleteConfirmation, BatchSessionArchiveConfirmation, InstallMode, PendingSidebarDeletion, Project, ReleaseInfo, SettingsProject } from '@/shared/types';
